...
@client.command(pass_context=True)
async def bananabc(ctx, *, message):
    channel = client.get_channel("521758985125232680")
    await client.send_message(channel, message)

@client.command(pass_context=True)
async def kidszonebc(ctx, *, message):
    channel = client.get_channel("261382678111191040")
    await client.send_message(channel, message)
